...
export const CategoryProductsAdmin = () => {
    ...
    const getDataCategoryProducts = async () => {
        try {
            const resProducts = await getApiCategoryProducts(0, 8);
            setDataCategoryProducts(resProducts.data);
    ...
    return (
        <ContainerAdmin>
            ...
            <ContainerRightAdmin>
                ...
                <DrawerRight valueProducts={valueCategortProducts} createData={createData} setAction={setAction} drawer={drawer} setDrawer={setDrawer} dataCategoryProducts={dataCategoryProducts} />
                <DataProducts data={dataCategoryProducts} deleteData={deleteData} onSubmitEditData={onSubmitEditData} />
            </ContainerRightAdmin>
        </ContainerAdmin>
    )
}